...
class Rank_Blocks_Color_5(Base_Task):
    ...
    def load_actors(self):
        ...
        #         or (block1_pose[0] < block2_pose[0] < block3_pose[0] < block4_pose[0] < block5_pose[0])
        #     ):
        #         continue
        #     else:
        #         break
        ...
        self.add_prohibit_area(self.block5, padding=0.05)

        self.prohibited_area.append([-0.17, -0.22, 0.17, -0.12])

        # 所有方块共用同一个目标 y，仅用于放置动作
