...
class Stamp_Seals_Order_4(Base_Task):
    ...
    def load_actors(self):
        self.stage_sum = 4
        self.stage = 0
        self._placed_stages = [False, False, False, False]
        ...
        idxs = np.random.choice(len(color_items), size=4, replace=False)
        ...
        self.pads = [self.target, self.target2, self.target3, self.target4]
