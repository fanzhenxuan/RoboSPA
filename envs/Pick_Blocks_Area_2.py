...
class Pick_Blocks_Area_2(Base_Task):
    ...
    def load_actors(self):
        ...
        # 2.3个block分别对应：第1大、第2大、第3大
        # 注意这里是half_size
        # halfsize_lst = [
        #     np.random.uniform(0.030, 0.032),  # 1st
        #     np.random.uniform(0.024, 0.026),  # 2nd
        #     np.random.uniform(0.018, 0.020),  # 3rd
        # ]
        halfsize_lst = [
        ...
        block_half_height = 0.027
        
        # 3.随机生成3个block位置，尽量分散，避免抓取时碰到其他block
        while True:
            block_pose_lst = []
