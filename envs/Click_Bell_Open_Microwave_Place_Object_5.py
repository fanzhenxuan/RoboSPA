...
class Click_Bell_Open_Microwave_Place_Object_5(Base_Task):
    ...
    def play_once(self):
        ...
        # ==================================================
        # print(f"Stage 3: {self.task_success}")
        self._do_one_click(bell_arm)
        self.last_gripper = bell_arm
        ...
        # ==================================================
        # Stage 5: 第三次 click bell
        # ==================================================
        # print(f"Stage 5: {self.task_success}")
        self._do_one_click(bell_arm)
        self.last_gripper = bell_arm
        self.update_progress()
        self.move(self.open_gripper(arm_tag=microwave_arm))
    ...
    def check_success(self):
        # print(f"Check success: {self.task_success}")
        self.update_progress()
