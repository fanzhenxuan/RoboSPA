...
class Stack_Blocks_Length_Order_5(Base_Task):
    ...
    def load_actors(self):
        ...
        # 长度设置参考 pick_length_5block_hzy_0312_final.py
        # 每个元素为 (half_x, half_y, half_z)
        # 顺序：从最长到最短
        self.halfsize_lst = [
    ...
    def play_once(self):
        ...
        #         desc = "shortest block"
        #     else:
        #         desc = f"block ranked {i + 1} by length"
        #
