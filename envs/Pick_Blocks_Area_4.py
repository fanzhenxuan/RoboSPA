...
class Pick_Blocks_Area_4(Base_Task):
    ...
    def load_actors(self):
        ...
        halfsize_lst = [
            ...
            np.random.uniform(0.027, 0.028),  # 1st
            np.random.uniform(0.022, 0.023),  # 2nd
            np.random.uniform(0.017, 0.018),  # 3rd
            np.random.uniform(0.012, 0.013),  # 4th
            np.random.uniform(0.009, 0.010),  # 5th
        ]
        block_half_height = 0.022
