...
class Rank_Blocks_Size_3(Base_Task):
    ...
    def load_actors(self):
        ...
        while True:
            ...
            ordered_x = (
                block1_pose[0] < block2_pose[0] < block3_pose[0]
            )
