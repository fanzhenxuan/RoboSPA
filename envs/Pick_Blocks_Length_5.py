...
class Pick_Blocks_Length_5(Base_Task):
    ...
    def load_actors(self):
        ...
        # 6个block时，为了兼顾区分性和稳定摆放，做相对均匀分层
        # halfsize_lst = [
        #     (np.random.uniform(0.0370, 0.0380), fixed_half_y, fixed_half_z),  # 1st longest
        #     (np.random.uniform(0.0320, 0.0330), fixed_half_y, fixed_half_z),  # 2nd
        #     (np.random.uniform(0.0270, 0.0280), fixed_half_y, fixed_half_z),  # 3rd
        #     (np.random.uniform(0.0220, 0.0230), fixed_half_y, fixed_half_z),  # 4th
        #     (np.random.uniform(0.0170, 0.0180), fixed_half_y, fixed_half_z),  # 5th
        #     (np.random.uniform(0.0120, 0.0130), fixed_half_y, fixed_half_z),  # 6th
        # ]
        ...
        halfsize_lst = [
            ...
            (np.random.uniform(0.0090, 0.0100), fixed_half_y, fixed_half_z),  # 6th
        ]
        ...
        for i in range(n_block):
            ...
            self.add_prohibit_area(block, padding=0.048)
