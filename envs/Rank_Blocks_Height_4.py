...
class Rank_Blocks_Height_4(Base_Task):
    ...
    def load_actors(self):
        ...
        # 去掉最高的，保留 4 个：高 -> 中 -> 低 -> 最低
        half_height_lst = [
            np.random.uniform(0.042, 0.044),  # tallest among remaining
            np.random.uniform(0.028, 0.030),  # 2nd
            np.random.uniform(0.016, 0.018),  # 3rd
