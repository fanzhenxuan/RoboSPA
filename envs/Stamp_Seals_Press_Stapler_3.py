...
class Stamp_Seals_Press_Stapler_3(Base_Task):
    ...
    def load_actors(self):
        ...
        self.required_right_seal_stage = 1
    ...
    def _do_stapler_press_once(self, stapler_arm_tag, prev_arm_tag=None):
        ...
        # retreat_z = 0.08  # 更稳健；如果还会蹭到，可调到0.10

        # if prev_arm_tag is not None and prev_arm_tag != stapler_arm_tag:
        #     # 新手臂去stapler上方的同时，旧手臂先原地竖直抬高
        #     self.move(
        #         stapler_hover_action,
        #         self.move_by_displacement(arm_tag=prev_arm_tag, z=retreat_z),
        #     )
        #     # 抬高后，再把旧手臂收回原点
        #     self.move(self.back_to_origin(arm_tag=prev_arm_tag))
        # else:
        ...
        self.move(self.move_by_displacement(arm_tag=stapler_arm_tag, z=0.12))
        self.update_progress()
