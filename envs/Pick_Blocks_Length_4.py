...
class Pick_Blocks_Length_4(Base_Task):
    ...
    def load_actors(self):
        ...
        # 保证相邻长度区间至少相差0.004
        # halfsize_lst = [
        #     (np.random.uniform(0.0330, 0.0340), fixed_half_y, fixed_half_z),  # 1st longest
        #     (np.random.uniform(0.0280, 0.0290), fixed_half_y, fixed_half_z),  # 2nd
        #     (np.random.uniform(0.0230, 0.0240), fixed_half_y, fixed_half_z),  # 3rd
        #     (np.random.uniform(0.0180, 0.0190), fixed_half_y, fixed_half_z),  # 4th
        #     (np.random.uniform(0.0130, 0.0140), fixed_half_y, fixed_half_z),  # 5th
        # ]
