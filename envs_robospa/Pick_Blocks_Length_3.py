...
class Pick_Blocks_Length_3(Base_Task):
    ...
    def load_actors(self):
        ...
        # 4个block时，仍保持较明显length差
        # halfsize_lst = [
        #     (np.random.uniform(0.0370, 0.0380), fixed_half_y, fixed_half_z),  # 1st longest
        #     (np.random.uniform(0.0290, 0.0300), fixed_half_y, fixed_half_z),  # 2nd
        #     (np.random.uniform(0.0210, 0.0220), fixed_half_y, fixed_half_z),  # 3rd
        #     (np.random.uniform(0.0130, 0.0140), fixed_half_y, fixed_half_z),  # 4th
        # ]
        ...
        self.rank_str_lst = ["1st", "2nd", "3rd", "4th"]
