...
class Pick_Blocks_Length_2(Base_Task):
    ...
    def load_actors(self):
        ...
        # 3个block时，length差也设置得比较明显
        # halfsize_lst = [
        #     (np.random.uniform(0.0380, 0.0390), fixed_half_y, fixed_half_z),  # 1st longest
        #     (np.random.uniform(0.0250, 0.0260), fixed_half_y, fixed_half_z),  # 2nd
        #     (np.random.uniform(0.0120, 0.0130), fixed_half_y, fixed_half_z),  # 3rd
        # ]
