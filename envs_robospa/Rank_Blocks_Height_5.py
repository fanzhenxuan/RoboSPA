...
class Rank_Blocks_Height_5(Base_Task):
    ...
    def load_actors(self):
        ...
        half_height_lst = [
            np.random.uniform(0.058, 0.060),  # tallest
            np.random.uniform(0.042, 0.044),  # 2nd
            np.random.uniform(0.028, 0.030),  # 3rd
            np.random.uniform(0.016, 0.018),  # 4th
            np.random.uniform(0.006, 0.008),  # shortest
        ]
        ...
        self.block3 = create_block(block_pose_lst[2], half_height_lst[2], color)
        self.block4 = create_block(block_pose_lst[3], half_height_lst[3], color)
        self.block5 = create_block(block_pose_lst[4], half_height_lst[4], color)
