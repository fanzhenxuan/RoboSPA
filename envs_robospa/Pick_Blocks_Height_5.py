...
class Pick_Blocks_Height_5(Base_Task):
    ...
    def load_actors(self):
        ...
        # 6个block时，为了兼顾可区分性和稳定摆放，做相对均匀分层
        halfsize_lst = [
            ...
            (fixed_half_x, fixed_half_y, np.random.uniform(0.0120, 0.0130)),  # 6th
        ]
        ...
        for i in range(n_block):
            ...
            self.add_prohibit_area(block, padding=0.015)
