...
class Pick_Rubik_Cubes_Canonical_5(Base_Task):
    ...
    def load_actors(self):
        ...
        center_y = np.random.uniform(-0.11, -0.10)
        col_gap = 0.136
        row_gap = 0.1
        ...
        x_jitter = min(0.010, max(0.004, 0.18 * obj_width))
        x_jitter = min(x_jitter, 0.18 * min_col_gap)

        y_jitter = min(0.005, max(0.002, 0.10 * obj_depth))
