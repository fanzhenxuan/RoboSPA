...
class Pick_Blocks_Length_1(Base_Task):
    ...
    def load_actors(self):
        ...
        # 2个block时，length差拉大，更明显
        # halfsize_lst = [
        #     (np.random.uniform(0.0380, 0.0400), fixed_half_y, fixed_half_z),  # 1st longest
        #     (np.random.uniform(0.0120, 0.0140), fixed_half_y, fixed_half_z),  # 2nd
        # ]
