...
class Pick_Mixed_Objects_Distance_B_5(Base_Task):
    """
    ...
    OBJECT_SPECS = [
        ...
        {'modelname': '002_bowl', 'skip_model_ids': []},
        {'modelname': '057_toycar', 'skip_model_ids': []},
        {'modelname': '099_fan', 'skip_model_ids': []},
        {'modelname': '023_tissue-box', 'skip_model_ids': []},
