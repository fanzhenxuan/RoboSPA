...
class Stamp_Seals_Order_2(Base_Task):
    ...
    def load_actors(self):
        self.stage_sum = 2
        self.stage = 0
        self._placed_stages = [False, False]
        ...
        idxs = np.random.choice(len(color_items), size=2, replace=False)
        ...
        self.pads = [self.target, self.target2]
