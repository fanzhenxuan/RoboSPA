...
class Pick_Mixed_Objects_Canonical_B_4(Base_Task):
    ...
    def load_actors(self):
            ...
            center_x = np.random.uniform(-0.08, 0.04)
            ...
            # 修改点 2：在生成 poses 时，判断物体是否为薯条，应用不同姿态
            poses = []
            idx = 0
            for y in y_values:
                for x in xs:
                    ...
                    target_qpos = [1, 0, 0, 0] if spec["modelname"] == "005_french-fries" else [0.5, 0.5, 0.5, 0.5]
