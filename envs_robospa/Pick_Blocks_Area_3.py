...
class Pick_Blocks_Area_3(Base_Task):
    ...
    def load_actors(self):
        ...
        # halfsize_lst = [
        #     np.random.uniform(0.0320, 0.0330),  # 1st
        #     np.random.uniform(0.0270, 0.0280),  # 2nd
        #     np.random.uniform(0.0220, 0.0230),  # 3rd
        #     np.random.uniform(0.0170, 0.0180),  # 4th
        # ]
        halfsize_lst = [
