...
class Put_Bottles_Dustbin_5(Base_Task):
    ...
    def load_actors(self):
        ...
        self.bottle_id = list(np.random.choice(available_ids, self.bottle_num, replace=True))
    ...
    def play_once(self):
        ...
        self.info["info"] = {
            ...
            # "{D}": f"114_bottle/base{self.bottle_id[3]}",
            # "{E}": f"114_bottle/base{self.bottle_id[4]}",
