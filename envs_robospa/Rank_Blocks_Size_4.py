...
class Rank_Blocks_Size_4(Base_Task):
    ...
    def load_actors(self):
        ...
        while True:
            ...
            # 避免初始状态已经接近满足目标排序：大 < 中 < 小 < 最小（从左到右）
            aligned_close = (
            ...
            ordered_x = (
                block1_pose[0] < block2_pose[0] < block3_pose[0] < block4_pose[0]
            )
        ...
        self.block1 = create_block(block_pose_lst[0], halfsize_lst[0], color)  # large
        self.block2 = create_block(block_pose_lst[1], halfsize_lst[1], color)  # medium
        self.block3 = create_block(block_pose_lst[2], halfsize_lst[2], color)  # small
        self.block4 = create_block(block_pose_lst[3], halfsize_lst[3], color)  # extra small
